...
# what to draw
#label = "#Delta#phi (#gamma-#slash{E}_{T})"
...
fdata = ROOT.TFile("~ncsmith/no_deltaphi_cut/data_selection.root")
fqcd = ROOT.TFile("~ncsmith/no_deltaphi_cut/qcd_selection.root")
fznunu = ROOT.TFile("~ncsmith/no_deltaphi_cut/znunu_selection.root")
fwJets = ROOT.TFile("~ncsmith/no_deltaphi_cut/wJets_selection.root")
fsig = ROOT.TFile("~ncsmith/no_deltaphi_cut/signal_selection.root")
...
legend.AddEntry(hznunu, "Z#nu#nu", "l")
